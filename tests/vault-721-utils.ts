...
export function createCreateProxyEvent(
  _user: Address,
  _proxy: Address
): CreateProxy {
  let createProxyEvent = changetype<CreateProxy>(newMockEvent())

  createProxyEvent.parameters = new Array()

  createProxyEvent.parameters.push(
